    ...
    Given("주문을 저장 할 때") {
        ...
        When("유효하지 않은 상품 옵션을 입력하면") {
            ...
            val orderProductCommands = listOf(
                ...
                orderProductCommand(
                    ...
                    additionalPrice = productOptionB.additionalPrice,
                ),
            )
            val command = saveOrderCommand(
                memberId = memberId,
        ...
        When("존재 하지 않는 배송 정보를 입력 하면") {
            ...
            val orderProductCommands = listOf(
                orderProductCommand(
                    ...
                    additionalPrice = productOptionA.additionalPrice,
                ),
            )
        ...
        When("주문 상품과 실제 상품의 가격이 다르면") {
            ...
            val orderProductCommands = listOf(
                orderProductCommand(
                    productId = productA.id,
                    originalPrice = productA.price,
                    discountRate = productA.discountRate,
                    discountPrice = productA.discountPrice,
                    sex = productOptionA.sex,
        ...
        When("전체 주문 금액이 일치 하지 않으면") {
            ...
            val orderProductCommands = listOf(
                ...
                orderProductCommand(
                    productId = productA2.id,
                    originalPrice = productA2.price,
                    discountRate = productA2.discountRate,
                    discountPrice = productA2.discountPrice,
                    sex = productOptionA2.sex,
                    orderPrice = BigDecimal.ONE,
                    additionalPrice = productOptionA2.additionalPrice,
                    deliveryFee = 3000.toBigDecimal(),
                    deliveryMethod = COMMON,
                ),
                orderProductCommand(
